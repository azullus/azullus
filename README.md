...
I build tools and automation for enterprise IT operations, with a focus on Windows infrastructure, Docker orchestration, and security hardening.
...
- 🐳 Architecting self-hosted infrastructure with Docker
- 🔒 Security research and penetration testing (PNPT training)
- 📱 Developing production-ready PWAs with Next.js

## 📫 Connect

- **GitHub**: [@azullus](https://github.com/azullus)
